...
export function Contact() {
  const contacts = [
    {
      type: "Email",
      value: "oscarhouessou0@gmail.com",
    ...
    {
      type: "LinkedIn",
      value: "linkedin.com/in/oscarhouessou",
    ...
    {
      type: "WhatsApp",
      value: "+229 0165509716",
      href: "https://wa.me/2290165509716",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 gap-6">
          {contacts.map((contact, index) => (
            <a
              ...
              className="flex items-center gap-4 p-4 bg-white dark:bg-gray-800/50 rounded-xl shadow-lg hover:shadow-xl transition-shadow"
            >
